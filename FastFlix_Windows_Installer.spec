...
a = Analysis(['fastflix\\__main__.py'],
             binaries=[],
             datas=[('iso-639-3.tab', 'iso639'), ('iso-639-3.json', 'iso639'), ('CHANGES', 'fastflix\\.'), ('vvencapp.exe', 'fastflix\\.'), ('vvencFFapp.exe', 'fastflix\\.'), ('docs\\build-licenses.txt', 'docs')] + all_fastflix_files,
